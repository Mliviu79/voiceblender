...
func WebhookFieldDescriptions() map[string]string {
	return map[string]string{
		...
		"playback.finished.reason":      "Why playback ended: 'completed' (reached the end of the audio) or 'stopped' (did not reach the end, for any reason)",
		"playback.finished.played_ms":   "Milliseconds of audio actually played, accumulated across repeat iterations",
		...
		"tts.finished.reason":    "Why the utterance ended: 'completed' (reached the end of the audio) or 'stopped' (did not reach the end, for any reason)",
		"tts.finished.played_ms": "Milliseconds of audio actually played",
